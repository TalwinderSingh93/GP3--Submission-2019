...
void Model::Load()
{
	...
	Assimp::Importer importer;													//TODO: aiProcess_GenNormals otherwise it doesn work for models with normal vectors inside
...
Model::~Model()
{
	// delete vbo vao find functions TODO:
	//search for delete function, is not glDeleteFrameBuffers
}
